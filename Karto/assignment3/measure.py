...
K1K1  = pr(Deg.guess('84-03-08.3').frac + P)
K1K2  = rp(Deg.guess('112-58-25.4').frac + S)
K1K3  = vp(Deg.guess('54.3107235').frac + L)
K1K4  = pr(Deg.guess('84-33-44.2').frac + S)
K1K5  = pv(Deg.guess('7.8383177').frac + P)
K1K6  = vp(Deg.guess('23-15-32.7').frac + P)
K1K7  = pv(Deg.guess('126.2540802').frac + K)
K1K8  = pv(Deg.guess('205-29-57.8').frac + K)
K1K9  = rs(Deg.guess('101.7366025').frac + S)
K1K10 = sv(Deg.guess('160-23-45.2').frac + T)
K1K11 = pv(Deg.guess('79.8680017').frac + K)
K1K12 = vs(Deg.guess('52-28-42.4').frac + R)
K1K13 = sr(Deg.guess('109-01-49.8').frac + T)
K2K1  = vs(Deg.guess('84-00-34.4').frac + L)
K2K2  = rs(Deg.guess('76.1245808').frac + N)
K2K3  = pr(Deg.guess('54-13-28.3').frac + P)
K2K4  = rp(Deg.guess('182.7394778').frac + S)
K2K5  = sr(Deg.guess('162-45-25.7').frac + L)
K2K6  = pr(Deg.guess('60-41-55.2').frac + S)
