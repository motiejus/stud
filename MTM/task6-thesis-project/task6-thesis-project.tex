...
\node[entity] (priezastis) {\begin{varwidth}{5cm}
    \textbf{Priežastis:} neaišku, kuri prognozė tiksliausia
\end{varwidth}};


\node[entity] (problema) [above = of priezastis] [align=left] {\begin{varwidth}{5cm}
    \textbf{Problema:} planuojant rytojaus dieną buvo remtasi netikslia orų prognoze
\end{varwidth}};


\node[entity] (pasekme1) [above left = of problema] {\begin{varwidth}{5cm}
    \textbf{Pasėkmė 1:} žemės ūkis ruošiasi sėjai, nors artimiausias kelias dienas nelis.
\end{varwidth}};

\node[entity] (pasekme2) [above = of problema] {\begin{varwidth}{5cm}
    \textbf{Pasėkmė 2:} kelininkai ruošiasi tiesti kelio atkarpą, kurioje tuo metu lis.
\end{varwidth}};

\node[entity] (pasekme3) [above right = of problema] {\begin{varwidth}{5cm}
    \textbf{Pasėkmė 3:} išėjome į žygį, ir po pietų pradėjo lyti. O išmainėme muziejų dieną į žygį.
\end{varwidth}};
